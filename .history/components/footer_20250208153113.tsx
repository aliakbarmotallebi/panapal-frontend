...
export function Footer({ links }: FooterProps) {
  return (
    <>
      <section className="bg-blue-800 relative overflow-hidden">
        <div className="absolute top-0 start-0 z-10 opacity-30 rotate-45">
          <div className="absolute -right-20 -top-10 z-10 w-40 rounded-3xl bg-white/30 shadow-2xl h-52"></div>
          <div className="absolute -right-15 -top-5 z-20 w-40 rounded-3xl bg-white/50 shadow-2xl h-52"></div>
          <div className="absolute -right-10 -top-5 z-20 w-40 rounded-3xl bg-white/50 shadow-2xl h-52"></div>
          <div className="absolute -right-5 -top-5 z-20 w-40 rounded-3xl bg-white/50 shadow-2xl h-52"></div>
          <div className="relative z-30 w-40 overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-2xl h-52"></div>
        </div>
        <div className="absolute end-0 bottom-0 z-10 opacity-30 rotate-45 -left-12">
          <div className="absolute -right-20 -top-10 z-10 w-52 rounded-3xl bg-white/30 shadow-2xl h-80"></div>
          <div className="absolute -right-15 -top-5 z-20 w-52 rounded-3xl bg-white/50 shadow-2xl h-80"></div>
          <div className="absolute -right-10 -top-5 z-20 w-40 rounded-3xl bg-white/50 shadow-2xl h-52"></div>
          <div className="absolute -right-5 -top-5 z-20 w-40 rounded-3xl bg-white/50 shadow-2xl h-52"></div>
          <div className="relative z-30 w-52 rounded-3xl border border-gray-200 bg-white shadow-2xl h-80"></div>
        </div>
        <div className="mx-auto max-w-7xl text-gray-700 flex flex-col items-center">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            ...
            >
              ...
              <span className="text-sm font-medium">همین حالا شروع کنید.</span>
              <svg
            ...
            <p className="mb-8 text-lg font-normal text-gray-200 lg:text-xl sm:px-16 lg:px-48">
              با ایجاد حساب کاربری از خدمات جیبیت برای رشد و ارتقا فرآیند و
              عملیات مالی کسب و کارتان استفاده کنید.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              >
                <p className="mb-6 text-xl font-bold text-neutral-900 md:text-2xl">
                  درباره پاناپال
                </p>
                <p className="text-justify text-base leading-9 text-stone-700">
              ...
              <div className="mr-2">
                <div>
                  <ul className="inline-flex items-center gap-3 flex-row">
                    <li>
                      <div className="w-20 h-20 border hover:bg-blue-50 rounded-2xl bg-white shadow">
                        <a
                          target="_blank"
                          href="https://trustseal.enamad.ir/?id=283830&Code=48SB7qor0DjY6ksaf9W0"
                        >
                          <img
                            referrerpolicy="origin"
                            className="h-full p-2"
                            src="/assets/images/namad/e-namad.png' }}"
                          />
                        </a>
                      </div>
                    </li>
                    <li>
                      <div className="w-20 h-20 border hover:bg-blue-50 rounded-2xl bg-white shadow">
                        <img
                          alt="logo-samandehi"
                          referrerpolicy="origin"
                          src="/assets/images/namad/samandehi.png' }}"
                          className="h-full p-2"
                        />
                      </div>
                    </li>
                      ...
                      <div className="w-20 h-20 border hover:bg-blue-50 rounded-2xl bg-white shadow">
                        <a href="https://logo.saramad.ir/verify.aspx?CodeShamad=1-2-767877-63-0-1">
                          <img
                            ...
                            src="/assets/images/namad/rasaneh2.svg' }}"
                          />
                        </a>
                      </div>
                    </li>
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6"></div>
          </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              ...
              - پلتفرم برتر پرداخت یار © {new Date().getFullYear()} . تمامی حقوق
              متعلق به شرکت
              <span className="text-blue-500">پاناپال</span>
              است.
            </div>
            <section
              id="social-media"
            ...
            >
              <div className="flex flex-row gap-2">
                <a
                  href="#"
                  className="hover:text-blue-600/90  hover:border-blue-600/90 delay-150 hover:-translate-y-1 relative flex items-center justify-center rounded-2xl border border-neutral-200 p-3 text-neutral-900 transition-all"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
