      ...
      <nav {...props}>
        <div className="flex h-14 items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-300/30 px-3 backdrop-blur-sm">
          ...
          <div className="mr-6">
            <a
              href=""
              className="sm:hidden inline-flex items-center rounded-lg bg-blue-800 px-5 py-2.5 text-sm font-medium text-white hover:bg-neutral-900 focus:outline-none focus:ring-4 focus:ring-neutral-300"
              href=""
            >
