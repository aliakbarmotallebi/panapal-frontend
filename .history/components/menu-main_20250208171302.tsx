      ...
      <nav {...props}>
        <div className="flex h-14 items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-300/30 px-3 backdrop-blur-sm">
          ...
          <div className="ml-2 flex sm:hidden">
            ...
            <nav
              id="header-nav"
              className="grid-rows-[1fr] visible bg-whitshadow-lg opacity-100 absolute inset-x-0 top-full z-50 mt-1 grid grid-rows-[0fr] rounded-xl shadow-black/[.04] transition-all duration-300"
            >
