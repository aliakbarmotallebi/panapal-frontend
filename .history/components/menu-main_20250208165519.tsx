      ...
      <nav {...props}>
        <div className="flex h-14 items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-300/30 px-3 backdrop-blur-sm">
          ...
          <div className="mr-6">
            <a
              href=""
              className="inline-flex items-center rounded-lg bg-blue-800 px-5 py-2.5 text-sm font-medium text-white hover:bg-neutral-900 focus:outline-none focus:ring-4 focus:ring-neutral-300"
              href=""
            >
          ...
          <div className="ml-2 flex sm:hidden">
            ...
            <nav
              id="header-nav"
              className="[&amp;.menu-is-open]:grid-rows-[1fr] [&amp;.menu-is-open]:visible [&amp;.menu-is-open]:bg-white [&amp;.menu-is-open]:shadow-lg [&amp;>div]:opacity-0 [&amp;.menu-is-open>div]:opacity-100 absolute inset-x-0 top-full z-50 mt-1 grid grid-rows-[0fr] rounded-xl shadow-black/[.04] transition-all duration-300"
            >
                ...
                <ul className="divide-y divide-neutral-100 px-3 py-1.5 text-sm">
                  <li>
                    <a
                      ...
                      className="flex px-2 py-2 text-neutral-800 hover:underline"
                    >
                      Documentation
                    </a>
                  </li>
