  ...
  return (
    ...
    <section className="max-w-7xl mx-auto relative pb-32 pt-16">
      ...
      <div className="w-full shadow p-7 pb-7 rounded-lg bg-white absolute -bottom-1/2">
        <div className="relative">
          ...
          <input type="text" placeholder="عبارت ویا کلمه مدنظر خودرا تایپ کنید..." className="px-8 py-3 w-full rounded-md border border-gray-200 focus:border-gray-500 focus:bg-white focus:ring-0" />
        </div>
        ...
        <div className="flex items-center justify-between my-4">
          ...
          <div className="pt-4 w-full">
            <ul className="flex flex-wrap text-base font-medium text-center text-gray-500 gap-1 gap-y-8">
              <li>
                <a href="#" className="py-2.5 px-5 text-base font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 bg-blue-600" aria-current="page">
                  دسته بندی 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               1
                </a>
              </li>
              <li>
                <a href="#" className="py-2.5 px-5 text-base font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                  دسته بندی 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               2
                </a>
              </li>
    ...
    <div>
      ...
      <div className="hidden lg:block absolute bottom-0 left-0 rounded-b-[50px] w-full h-full">
        <Image src="images/hero-bg.svg" alt="hero" />
      </div>
    </div>
  </header>
      ...
      <div
        ...
        <div className="border w-full flex flex-col lg:flex-row lg:items-center gap-7.5 lg:gap-11 bg-white shadow-1 rounded-xl p-4 lg:p-2.5">
          <div className="w-full rounded-md shadow-lg overflow-hidden">
            <div className="relative pb-96 bg-red-100">
              <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/800/600" alt="hero" />
              <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
            </div>
          </div>
  
          <div className="lg:max-w-[540px] w-full">
            <a href="#" className="my-4 bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded border border-blue-400">
              تکنولوژی
            </a>
        ...
        <div
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=1" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=2" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=3" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=4" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=5" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <Image className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=6" alt="hero" />
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
