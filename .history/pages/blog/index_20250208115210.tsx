      ...
      <div
        ...
        <div className="border w-full flex flex-col lg:flex-row lg:items-center gap-7.5 lg:gap-11 bg-white shadow-1 rounded-xl p-4 lg:p-2.5">
          <div className="w-full rounded-md shadow-lg overflow-hidden">
            <div className="relative pb-96 bg-red-100">
              <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/800/600" alt="hero">
        ...
        <div
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=1" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=2" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=3" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=4" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=5" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center gap-6 bg-white border shadow-1 rounded-xl p-2.5 relative hover:scale-105 hover:shadow-md duration-150 transition-transform">
            <div className="w-full rounded-md shadow-lg overflow-hidden">
              <div className="relative pb-52 bg-red-100">
                <img className="absolute h-full w-full bg-cover" src="https://picsum.photos/200/300?random=6" alt="hero">
                <a href="http://" className="top-0 right-0 w-full h-full absolute"></a>
              </div>
            </div>
